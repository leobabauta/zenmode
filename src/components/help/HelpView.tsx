    ...
    items: [
      {
        ...
        a: 'It\'s a guided morning routine that helps you start your day with intention. You\'ll triage your inbox, import calendar events, organize your tasks, and pick your top priorities. It takes just a few minutes.',
      },
      {
